...
return [
    ...
    */
    'menu' => [
        ...
        // 👤──────────────────────────────
        ['header' => 'GESTIÓN DE USUARIOS Y ROLES'],
        [
        ...
        [
            'text' => 'Nutricionistas',
            'route' => 'nutricionistas.index',
            'icon' => 'fas fa-apple-alt',
            'can' => 'nutricionistas.view',
        ],
        [
            'text' => 'Administrativos',
            'route' => 'administrativos.index',
            'icon' => 'fas fa-user-tie',
            'can' => 'administrativos.view',
        ],

        // 🏋️──────────────────────────────
        ['header' => 'GESTIÓN DE ENTRENAMIENTO'],
        [
            'text' => 'Disciplinas',
        ...
        [
            ...
            'can' => 'suscripciones.view'
        ],
        [
            'text' => 'Promociones',
            'route' => 'promociones.index',
            'icon' => 'fas fa-percentage',
            'can' => 'promociones.view'
        ],
        [
            'text' => 'Pagos y Comprobantes',
            'icon' => 'fas fa-wallet',
            'submenu' => [
                [
                    'text' => 'Pagos',
